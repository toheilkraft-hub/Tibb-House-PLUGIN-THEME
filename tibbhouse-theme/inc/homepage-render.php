...
/**
 * Render a card grid section for a given set of posts.
 *
...
/**
 * Render the full Tibb House homepage layout: hero, Treatments grid,
 * quote divider, Conditions grid, Practitioners grid — all pulled live
...
function tibbhouse_render_homepage() {
	$treatments    = tibbhouse_get_featured( 'treatments', 3 );
	$conditions    = tibbhouse_get_featured( 'conditions', 3 );
	$practitioners = tibbhouse_get_featured( 'practitioners', 3 );
	?>
	...
	<?php if ( $treatments ) : ?>
		<?php tibbhouse_homepage_cards( $treatments, get_post_type_archive_link( 'treatments' ), __( 'Treatments', 'tibbhouse' ), __( 'Treatment', 'tibbhouse' ) ); ?>
	<?php endif; ?>
	...
	<?php if ( $conditions ) : ?>
		<?php tibbhouse_homepage_cards( $conditions, get_post_type_archive_link( 'conditions' ), __( 'Conditions', 'tibbhouse' ), __( 'Condition', 'tibbhouse' ) ); ?>
	<?php endif; ?>

	<?php if ( $practitioners ) : ?>
		<?php tibbhouse_homepage_cards( $practitioners, get_post_type_archive_link( 'practitioners' ), __( 'Practitioners', 'tibbhouse' ), __( 'Practitioner', 'tibbhouse' ) ); ?>
	<?php endif; ?>
	<?php
}
